...
// (GUID prefix + displayName suffix). Guards the select-edition →
// active-edition → pbiviz.mjs handoff: if the channel were silently dropped
// anywhere along it, the package would carry the PRODUCTION visual ID and
// must never be published as a channel build.
