...
- [Verify an audit finding's premise against the actual runtime before acting](../workflow-issues/verify-audit-finding-premise-before-acting-2026-07-02.md) — the canonical statement of the meta-rule; this convention's step 4 ("verify the regression claim structurally, not by inspection alone") is a specific instance of it.
